...
See, a UUID only contains standard hexadecimal characters (0-9, A-F) and this one had chars like `P`, `R` and `A`. Looks like we finally found the second half of the flag- in the nick of time.
